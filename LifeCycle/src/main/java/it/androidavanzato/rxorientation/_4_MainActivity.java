...
public class _4_MainActivity extends AppCompatActivity {

    public static final String ITEMS = "items";

    private StringAdapter adapter;

    private RetainedObservableFragment4<ArrayList<String>> retainedFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retainedFragment = Fragments.getOrCreate(this, "retained", RetainedObservableFragment4::new);
    ...
    @OnClick(R.id.refresh) void reloadData() {
        ...
        subscriptions.add(retainedFragment.bind(observable.replay()));
    }
